    ...
    try {
        ...
        if (isS3) {
            if (Bucket && reportContent) {
                ...
                report = s3Response === null || s3Response === void 0 ? void 0 : s3Response.Location;
            }
            if (finalScreenshotAwsBucket) {
                const finalScreenshotData = (_d = (_c = (_b = (_a = results === null || results === void 0 ? void 0 : results.lhr) === null || _a === void 0 ? void 0 : _a.audits) === null || _b === void 0 ? void 0 : _b['final-screenshot']) === null || _c === void 0 ? void 0 : _c.details) === null || _d === void 0 ? void 0 : _d.data;
        ...
        let opportunities = [];
        if (isExperimental && ((_f = (_e = parsedResult === null || parsedResult === void 0 ? void 0 : parsedResult.categories) === null || _e === void 0 ? void 0 : _e.performance) === null || _f === void 0 ? void 0 : _f.auditRefs)) {
            try {
